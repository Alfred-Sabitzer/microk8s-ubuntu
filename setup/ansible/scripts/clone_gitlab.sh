...
ansible k8s -m shell -a 'sudo rm -rf /home/ansible/gitlab/'
ansible k8s -m shell -a 'sudo mkdir -p /home/ansible/gitlab'
ansible k8s -m shell -a 'sudo chown ansible:ansible /home/ansible/gitlab'
echo "create tar ..."
