...
############################################################################################
#
# This script handles error situations during Rook/Ceph setup on MicroK8s.
# it starts a copy of /snap/microk8s/current/addons/core/addons/rook-ceph/plugin/.rook-import-external-cluster.sh
#
############################################################################################
set -euo pipefail
