...
Now lets go with the Server certificates (**Dont do this in reality**)
...
* Host test.http.slainte.at:443 was resolved.
* IPv6: (none)
* IPv4: 10.242.64.201
*   Trying 10.242.64.201:443...
* Connected to test.http.slainte.at (10.242.64.201) port 443
* ALPN: curl offers h2,http/1.1
* TLSv1.3 (OUT), TLS handshake, Client hello (1):
* TLSv1.3 (IN), TLS handshake, Server hello (2):
* TLSv1.3 (IN), TLS handshake, Encrypted Extensions (8):
...
*   Certificate level 0: Public key type RSA (2048/112 Bits/secBits), signed using sha256WithRSAEncryption
* using HTTP/2
* [HTTP/2] [1] OPENED stream for https://test.http.slainte.at/
* [HTTP/2] [1] [:method: GET]
* [HTTP/2] [1] [:scheme: https]
* [HTTP/2] [1] [:authority: test.http.slainte.at]
* [HTTP/2] [1] [:path: /]
* [HTTP/2] [1] [user-agent: curl/8.5.0]
* [HTTP/2] [1] [accept: */*]
> GET / HTTP/2
> Host: test.http.slainte.at
> User-Agent: curl/8.5.0
> Accept: */*
> 
...
< HTTP/2 404 
< date: Tue, 23 Dec 2025 09:44:28 GMT
< server: istio-envoy
< 
* Connection #0 to host test.http.slainte.at left intact
alfred@lxd:~/cert$ 
````
